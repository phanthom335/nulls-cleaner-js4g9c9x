        """
        Nulls Cleaner Js4g9c9x
        ======================
        Lightweight ETL component that can clean millions of rows efficiently.
...
from pathlib import Path
        ...
        APP_NAME    = "Nulls Cleaner Js4g9c9x"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight ETL component that can clean millions of rows efficiently.")
